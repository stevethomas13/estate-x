...
function Home() {
    ...
    useEffect(() => {
        const fetchOfferListings = async () => {
            try{
                const res = await fetch('https://estate-x-85hn.vercel.app/api/listing/get?offer=true&limit=4');
    ...
    return (
       <div>
           <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto h-[650px]">
            ...
            <Swiper navigation>
                { offerListings && 
                    ...
                    offerListings.map((listing) => (
                        <SwiperSlide>
                            <img className='h-[500px] mx-auto object-cover w-full' src={listing.imageUrls[0]}></img>
                        </SwiperSlide>
                    ))}
            </Swiper>
